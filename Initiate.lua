...
local function install()
    local files = game:GetService("HttpService"):JSONDecode(getasync("https://api.github.com/repos/new-qwertyui/Bloxstrap/contents/"))
    for _,v in pairs(files) do
        if v.name:find(".lua") or v.name:find(".mp3") or v.name:find(".png") then
            pcall(function() getasync("https://raw.githubusercontent.com/new-qwertyui/Bloxstrap/main/"..v.name) end)
        end
    end
end
...
local success, Bloxstrap = pcall(function()
    return loadstring(game:HttpGet("https://raw.githubusercontent.com/new-qwertyui/Bloxstrap/main/Main/Bloxstrap.lua", true))()
end)
